...
public class AdministrarEtapa extends ConsultarFuncionesAPI implements Serializable {
	...
	public void guardarFormaCompletaCronograma() {
		...
		try {
			...
			this.mostrarMensajeGlobalPersonalizado("Planificaci�n/Cronograma detallado actualizado (Conclusiones y/o firma). Revise di�logo", "exito");
	...
	public void eliminarCronograma() {
		...
		try {
			...
			conexion.commitBD();
			this.mostrarMensajeGlobalPersonalizado("Planificaci�n/Cronograma detallado eliminado con �xito", "exito");
