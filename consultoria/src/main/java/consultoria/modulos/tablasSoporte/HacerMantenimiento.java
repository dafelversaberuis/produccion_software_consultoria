...
public class HacerMantenimiento extends ConsultarFuncionesAPI implements Serializable {
	...
	/**
	 * Este m�todo borra el formulario de creaci�n de un arbolito
	 */
	...
	/**
	 * Este m�todo borra el formulario de edici�n de un arbolito en transacci�n
	 */
	...
	/**
	 * Asigna un arbolito para realizar una acci�n
	 * 
	 * @param aArbolito
	 * @param aVista
	 */
			...
			if (isValidoIva("E")) {
				...
				if (arbolitos != null && arbolitos.size() > 0) {
					for (Plan a : arbolitos) {
						...
						// puede ser que se cambi� el valor del iva
	...
	/**
	 * Este m�todo borra el formulario de creaci�n de un iva
	 */
	...
	/**
	 * Este m�todo borra el formulario de edici�n de un iva en transacci�n
	 */
	...
	/**
	 * Asigna un iva para realizar una acci�n
	 * 
	 * @param aAgrupador
	 * @param aVista
	 */
