...
public interface IConsultasDAO {
	...
	/**
	 * Obtiene los registros de iva de acuerdo a los par�metros especificados
	 * 
	 * @param aIva
	 * @return ivas
	 * @throws Exception
	...
	/**
	 * Obtiene los planes de acci�n de un indicador
	 * 
	 * @param aIndicador
	 * @return planes
	 * @throws Exception
	...
	/**
	 * Obtiene el adjunto de un documento si �ste existe
	 * 
	 * @param aDocumento
	 * @return documento
	 * @throws Exception
	...
	/**
	 * Obtiene un registro de planificaci�n general
	 * 
	...
	/**
	 * Obtiene un registro de tiempos planificaci�n
	 * 
	 * @param aPlanificacion
	 * @return tiempos
	 * @throws Exception
	...
	/**
	 * Obtiene los estados del proyecto de un cliente si es que ya est�n
	 * guardados
	 * 
	...
	/**
	 * Obtiene la informaci�n general de los indicadores
	 * 
	 * @param aInformacion
	 * @return registro
	 * @throws Exception
	...
	/**
	 * Obtiene un listado de planificaci�n seg�n objeto de entrada
	 * 
	 * @param aPlanificacion
	...
	/**
	 * Obtiene la persona del diagn�stico
	 * 
	...
	/**
	 * Obtiene las preguntas sobre una transacci�n at�mica
	 * 
	 * @param aPregunta
	 * @return preguntas
	 * @throws Exception
	...
	/**
	 * Obtiene las preguntas de un proyecto. La Excepci�n la muestra la l�gica
	 * de negocio
	 * 
	 * @param aPregunta
	 * @return preguntas
	...
	/**
	 * Obtiene los par�metrois de auditor�a
	 * 
